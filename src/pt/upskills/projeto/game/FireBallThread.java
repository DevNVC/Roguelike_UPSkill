...
import pt.upskills.projeto.objects.Explosion;
        ...
        while (control) {
            ...
            try {
                if (fireTile.validateImpact()) {
                    ...
                    Explosion explosion=new Explosion(fireTile.getPosition());
                    Engine.gui.addImage(explosion);
                    System.out.println("EXPLODE");
                    sleep(450);
                    Engine.gui.removeImage(explosion);
                    control = false;
                }
